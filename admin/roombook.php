        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="home.php"><i class="fa fa-dashboard"></i> Durum</a>
                    </li>
                    <li>
                        <a href="messages.php"><i class="fa fa-desktop"></i> Bülten</a>
                    </li>
					<li>
                        <a class="active-menu" href="roombook.php"><i class="fa fa-bar-chart-o"></i> Oda</a>
                    </li>
                    <li>
                        <a href="payment.php"><i class="fa fa-qrcode"></i> Ödeme</a>
                    </li>
					<li>
                        <a  href="profit.php"><i class="fa fa-qrcode"></i> Kar</a>
                    </li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Oda<small>	<?php echo  $curdate; ?> </small>
                        </h1>
                    </div>
                ...
                <th><?php echo $sta; ?></th>
                        ...
                        <div class="panel-footer">
                            <form method="post">
										...
										<label>Onayı Seçin</label>
<select name="conf" class="form-control">
    <option value selected> </option>
    <option value="Conform">Onayla</option>
</select>
