        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="messages.php"><i class="fa fa-desktop"></i> Bülten</a>
                    </li>
					<li>
                        <a href="roombook.php"><i class="fa fa-bar-chart-o"></i>Oda Rezervasyon</a>
                    </li>
                    <li>
                        <a href="Payment.php"><i class="fa fa-qrcode"></i> Odeme</a>
                    </li>
                    <li>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Olustur</h4>
                                        </div>
										<form method="post">
										...
										<div class="modal-body">
										<div class="form-group">
										  <label for="comment">Bülten</label>
